...
public class PlanoControllerWeb {
	...
	@GetMapping("/")
	public String formSimulaao(Model model) {
		model.addAttribute("planoComCustoRQ", new PlanoComCustoRequest());
	...
	public String calculoValorLigacao(@Valid PlanoComCustoRequest planoComCustoRQ, BindingResult result,
		Model model) {
